...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--ssid", type=str, help="WiFi SSID to connect to.", default="gopro-wifi")
    parser.add_argument("--password", type=str, help="Password of WiFi SSID.", default="gopro-wifi")
